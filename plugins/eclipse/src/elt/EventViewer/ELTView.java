...
public class ELTView extends ViewPart implements INotified {
	...
	protected Thread wsThread = null;
	protected WSocket logSocket = null;
	...
	public void processMessage(String msg, Object data) {
		if (msg.equals("ConnectionError"))
		{
			...
			Document old = root;
			try {
				root = XMLReader.appendString(root, (String)data);
